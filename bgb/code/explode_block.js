...
export default class ExplodeBlockClass extends SpriteClass {
    ...
    onRun(tick) {
        ...
        this.addParticle(cx,cy,ParticleClass.AFTER_SPRITES_LAYER,35,200,0.8,0.01,8,8,0.02,0.02,'particles/explode_red',16,0.3,false,550);
        this.addParticle(cx,cy,ParticleClass.AFTER_SPRITES_LAYER,25,140,0.7,0.01,6,6,0.01,0.01,'particles/explode_orange',8,0.25,false,540);
        this.addParticle(cx,cy,ParticleClass.AFTER_SPRITES_LAYER,15,60,0.6,0.01,4,4,0.005,0.005,'particles/explode_yellow',2,0.2,false,530);

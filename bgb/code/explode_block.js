...
export default class ExplodeBlockClass extends SpriteClass
{
    ...
    runAI()
    {
        ...
        this.game.map.addParticle(cx,cy,32,128,0.8,0.1,8,0.015,this.game.imageList.get('particles/explode_red'),10,550);
        this.game.map.addParticle(cx,cy,24,104,0.7,0.1,6,0.008,this.game.imageList.get('particles/explode_orange'),8,540);
        this.game.map.addParticle(cx,cy,16,64,0.6,0.1,4,0.005,this.game.imageList.get('particles/explode_yellow'),6,530);

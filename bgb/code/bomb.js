...
export default class BombClass extends SpriteClass {
    ...
    explode() {
        ...
        this.game.map.addParticle(cx,cy,24,104,0.7,0.1,6,0.008,'particles/explode_orange',8,false,540);
        this.game.map.addParticle(cx,cy,16,64,0.6,0.1,4,0.005,'particles/explode_yellow',6,false,530);

...
export default class BreakBlockStrongClass extends SpriteClass
{
    ...
    interactWithSprite(interactSprite,dataObj)
    {
        ...
        if ((interactSprite instanceof ExplodeBlockClass) || (interactSprite instanceof ExecutionersAxeClass) || (interactSprite instanceof SirBawkBawkClass) || (interactSprite instanceof EyeClass)) {
